...
package com.example.prasannakumarvardi.myapplication.backend.userApi.model;
...
public final class User extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<Person> emergencyContact;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<Person> getEmergencyContact() {
    return emergencyContact;
  }

  /**
   * @param emergencyContact emergencyContact or {@code null} for none
   */
  public User setEmergencyContact(java.util.List<Person> emergencyContact) {
